      ...
      <div class="contentDv">
        <div v-if="tabIndex == 0">
            ...
            <div class="school">
              <el-form ref="form" :model="form">
                <el-form-item label="学院名称">
                  <el-select v-model="form.collegeName" placeholder="请选择学院">
                ...
                <el-form-item label="入学年份">
                  <el-select v-model="form.enterSchool" placeholder="请选择入学年份">
                ...
                <el-form-item label="姓名">
                  <el-select v-model="form.name" placeholder="请选择姓名">
                    <el-option label="张可溶" value="张可溶"></el-option>
                    <el-option label="张卡" value="张卡"></el-option>
                  </el-select>
                </el-form-item>
              </el-form>
            </div>
          ...
          <div class="dialog-footer">
            ...
            <el-button type="primary" @click="addSenate()">添 加</el-button>
          </div>
        </div>
        <div v-else-if="tabIndex == 1">
          <div class="biaoge">
            <div class="xiazai">
              ...
              <div class="biaoge-content">
                <div class="icon">
                  <img src="@/assets/image/course/ic_folder.svg" alt="" />
                </div>
                <div class="text-title">空白花名册模板.execl</div>
                <div class="img">
                  <img src="@/assets/image/course/ic_popup_download.svg" alt="" />
                </div>
              </div>
            </div>
            <div class="xiazai">
              ...
              <div class="biaoge-content">
                ...
                <div class="text-title">空白花名册模板.execl</div>
                <div class="img">
                  <img src="@/assets/image/course/ic_popup_upload.svg" alt="" />
                </div>
          ...
          <div class="dialog-footer">
            <el-button class="cancel-button" @click="addDV = false">取 消</el-button>
            <el-button type="primary" @click="addTable()">导 入</el-button>
          </div>
        </div>
        <div v-else>
          <div class="yaoqingma">
