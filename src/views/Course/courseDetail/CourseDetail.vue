            ...
            <div class="center-content">
              ...
              >
                <el-carousel-item v-for="item in 1" :key="item">
                  <div class="content">
                    本专业旨在培养社会急需的具备
                    大数据处理及分析能力的高级复合型人才。具体包括：掌握计算机科学、大数据科学与信息技术的基本理论、方法和技能，受到系统的科学研究训练，具备一定的大数据科学研究
                    <div class="bottom-content">
                      <div class="bottom-msg">
                        <div class="header">
                          <img
                            src="@/assets/image/home/course_img1.svg"
                            alt=""
                          />
                        </div>
      ...
      <el-row :gutter="60" class="el-row">
        ...
        <el-col :xs="12" :sm="8" :md="8" :lg="4" :xl="4">
          <a href="">
            <div class="img-item">
              <img
                src="@/assets/image/course/icon_course_exercises.svg"
                alt=""
              />
              <span>题库</span>
            </div>
        ...
        <el-col :xs="12" :sm="8" :md="8" :lg="4" :xl="4">
          <a href="">
            <div class="img-item">
              <img
                src="@/assets/image/course/icon_course_homework.svg"
                alt=""
              />
              <span>发布作业</span>
            </div>
      ...
      <el-row :gutter="32" class="el-row">
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="16" :xl="16">
          ...
          <div class="bottom-right">
            <div class="data">
              <div class="data-item">
                <div class="num">56756</div>
                <div class="text">视频播放量</div>
              </div>
              <div class="data-item">
                <div class="num">56756</div>
    ...
    .top-left {
      ...
      .left-img {
        ...
        span {
          ...
          font-weight: bold;
          color: #ffffff;
          text-shadow: 0rem 0.03rem 0.06rem rgba(0, 0, 0, 0.16);
          opacity: 0;
        }
      }
      .right-content {
      ...
      .chart {
        ...
        .nav {
          ...
          .title {
            ...
            font-weight: bold;
            color: #666666;
            border-left: 0.08rem solid #2a77ff;
          }
        }
      }
    }
